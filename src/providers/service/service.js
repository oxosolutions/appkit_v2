...
var ServiceProvider = /** @class */ (function () {
    function ServiceProvider(http, sqlite) {
        this.http = http;
        this.sqlite = sqlite;
        //public db = window.db;
        this.slugs = [];
    ...
    ServiceProvider.prototype.connection = function () {
        // let db;
        return this.db = window.openDatabase("test.db", '1', 'my', 1024 * 1024 * 100);
    };
    ServiceProvider.prototype.metaQuery = function (db, record, tableName) {
        var columns = [];
        var values = [];
        var tablekeys;
    ...
    ServiceProvider.prototype.insertProduct = function (db, record, tableName) {
        var _this = this;
        var columns = [];
        var values = [];
        var slugdata;
    ...
    ServiceProvider.prototype.productupdate = function (values, db, tableName, columns, i) {
        var _this = this;
        if (i === void 0) { i = 0; }
    ...
    ServiceProvider.prototype.insertQuery = function (db, record, tableName) {
        var _this = this;
        var columns = [];
        var values = [];
        var slugdata;
    ...
    ServiceProvider.prototype.update = function (values, db, tableName, columns, i) {
        var _this = this;
        if (i === void 0) { i = 0; }
        //console.log('pages');
        if (values[i] != undefined) {
    ...
    ServiceProvider.prototype.insertData = function (values, db, tableName, columns, i) {
        var _this = this;
        if (i === void 0) { i = 0; }
        if (values[i] != undefined) {
            var questionMarks_2 = [];
    ...
    ServiceProvider.prototype.create = function (db, record, tableName) {
    ...
    ServiceProvider.prototype.SelectPages = function (db, tableName) {
        var _this = this;
    ...
    ServiceProvider.prototype.SelectProducts = function (db, tableName) {
        var _this = this;
        var key;
        var i;
        var data = [];
    ...
    ServiceProvider.prototype.SelectProductDetail = function (db, tableName, id) {
        var _this = this;
        var productDetail;
        console.log(tableName);
        if (this.db != undefined) {
    ...
    ServiceProvider.prototype.SelectMeta = function (db, tableName) {
        var _this = this;
        if (this.db != undefined) {
            return new Promise(function (resolve, reject) {
                _this.db.transaction(function (tx) {
    ...
    ServiceProvider.prototype.DeleteAll = function (db, tableName) {
        // console.log(tableName);
        var _this = this;
        this.db.transaction(function (tx) {
            ...
            tx.executeSql('Delete  from ' + tableName, [], function (tx, result) {
                ...
                if (result.rows.length > 0) {
                    ...
                    _this.insertProduct(db, tableName);
